...
IUAVGadgetConfiguration *SystemHealthGadgetFactory::createConfiguration(QSettings &settings)
{
    return new SystemHealthGadgetConfiguration(QString("SystemHealthGadget"), settings);
}
