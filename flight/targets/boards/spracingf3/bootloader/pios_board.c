...
void setupCom()
{
    ...
    if (PIOS_USART_Init(&pios_usart_generic_id, &pios_usart_cfg[0])) {
        PIOS_Assert(0);
    }
    ...
    PIOS_COM_ChangeConfig(PIOS_COM_TELEM_USB, PIOS_COM_Word_length_8b, PIOS_COM_Parity_No, PIOS_COM_StopBits_1, 57600);
}
