...
#define PIOS_DMA_PIN_CONFIG                                                    \
    {                                                                          \
        { GPIOC, GPIO_Pin_3, ADC_Channel_13, false }, /* BAT_VOLTAGE PIN 1  */ \
        { GPIOC, GPIO_Pin_2, ADC_Channel_12, false }, /* BAT_VOLTAGE PIN 2  */ \
        { GPIOC, GPIO_Pin_1, ADC_Channel_11, false }, /* BAT_VOLTAGE PIN 3  */ \
        { GPIOC, GPIO_Pin_0, ADC_Channel_10, false }, /* BAT_VOLTAGE PIN 4  */ \
        { GPIOA, GPIO_Pin_2, ADC_Channel_2, false },  /* BAT_CURRENT PIN 3  */ \
                                                                               \
        { GPIOA, GPIO_Pin_1, ADC_Channel_1, false },  /* USART2 PIN TX      */ \
        { GPIOA, GPIO_Pin_0, ADC_Channel_0, false },  /* USART2 PIN RX      */ \
                                                                               \
