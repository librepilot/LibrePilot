...
ifeq ($(UNAME), Linux)
    ifeq ($(ARCH), x86_64)
        OSG_SDK_DIR := $(TOOLS_DIR)/osg-2705fde9e4-linux-x64-qt-5.4.1
    else
        OSG_SDK_DIR := $(TOOLS_DIR)/osg-2705fde9e4-linux-x86-qt-5.4.1
    endif
else ifeq ($(UNAME), Darwin)
    OSG_SDK_DIR := $(TOOLS_DIR)/osg-2705fde9e4-clang_64-qt-5.4.1
else ifeq ($(UNAME), Windows)
    ...
    OSG_SDK_DIR  := $(TOOLS_DIR)/osg-2705fde9e4-mingw491_32-qt-5.4.1
endif
