...
#define PIOS_USB_BOARD_PRODUCT_ID      USB_PRODUCT_ID_LIBREPILOT
#define PIOS_USB_BOARD_DEVICE_VER      USB_OP_DEVICE_VER(USB_OP_BOARD_ID_SPRACINGF3EVO, USB_OP_BOARD_MODE_FW)
